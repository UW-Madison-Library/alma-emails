                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 20px;">
                                                                    <tr>
                                                                        <td>
                                                                            The item <b><xsl:value-of select="notification_data/item_loan/title"/></b>
                                                                            is due back by <b><xsl:value-of select="notification_data/due_date"/></b>.
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding-top: 20px;">
                                                                            <xsl:if test="notification_data/has_fine_value='TRUE'">
                                                                                A <b><xsl:value-of select="notification_data/amount"/>&#160;<xsl:value-of select="notification_data/currency_symbol"/></b>
                                                                                fine will be added for each <xsl:value-of select="notification_data/uom"/>
                                                                                 it's late until it's returned.
                                                                            </xsl:if>
                                                                        </td>
                                                                    </tr>
                                                                </table>
