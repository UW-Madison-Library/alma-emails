                                            ...
                                            <tr>
                                                <td align="center" valign="top" style="padding: 20px;">
                                                    <table class="mainContent" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; max-width: 500px!important;">
														...
														<tr>
															<td><xsl:value-of select="notification_data/section_notice"/>,
															<br/><br/><xsl:choose>
																<xsl:when test="normalize-space(notification_data/tableName) = ''">
																	<xsl:value-of select="notification_data/main_notice" />
																</xsl:when>
																<xsl:otherwise>
																	<xsl:value-of select="notification_data/message_notice_table" />
																</xsl:otherwise>
															</xsl:choose>
