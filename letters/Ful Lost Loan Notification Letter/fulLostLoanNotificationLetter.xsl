                                                        ...
                                                        <tr>
                                                            <td style="margin: 0; padding: 10px 0;">
                                                                <h1 style="font-weight: normal; border-bottom: 1px solid lightgrey; padding-bottom: 10px; text-align: center; font-size: 20px!important;border-top: 1px solid lightgrey; padding-top: 13px;">
                                                                    Library Account Update: Lost Items and Fees
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 20px;">
                                                                     <tr>
                                                                        <td style="margin: 0;">
                                                                            The items listed below have been marked as lost. A <a href="https://www.library.wisc.edu/borrow-request/fines-and-holds/" style="color: #0073CE;" target="_blank">Lost Item Replacement Fee</a> has been added to your library account for each lost item.
                                                                            <br/><br/>To remove the fee, you can:<br/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <ol>
                                                                                <li><b>Return the lost items</b>: In most cases, the fee will be removed from your account immediately.</li>
                                                                                <li><b>Pay the Lost Item Replacement Fee</b>: Sign in to your <a href="https://account.library.wisc.edu/" style="color: #0073CE;" target="_blank">library account</a> or contact us directly to pay your fee.</li>
                                                                                <li><b>Ask about providing a replacement</b>: In some cases, you may be able to purchase a replacement and give it to the Libraries.</li>
                                                                            </ol>
                                                                        </td>
                                                                    </tr>
