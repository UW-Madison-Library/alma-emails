...
<strong> @@returned_to@@: <xsl:value-of select="notification_data/alternate_symbol"/></strong><br />
					<strong><xsl:value-of select="notification_data/partner_name"/></strong><br />
							...
							<xsl:if test="notification_data/partner_address/line5 !=''">
									...
									<xsl:value-of select="notification_data/partner_address/line5"/><br />
								
							</xsl:if>
							<xsl:if test="notification_data/partner_address/city !=''">
							
								    <xsl:value-of select="notification_data/partner_address/city"/>,&#160;<xsl:value-of select="notification_data/partner_address/state_province"/>&#160;<xsl:value-of select="notification_data/partner_address/state"/>&#160;<xsl:value-of select="notification_data/partner_address/postal_code"/>
							
							</xsl:if><br />
							<xsl:if test="notification_data/partner_address/country !=''">
								
									<xsl:value-of select="notification_data/partner_address/country"/> | <xsl:value-of select="notification_data/partner_address/country_display"/>
