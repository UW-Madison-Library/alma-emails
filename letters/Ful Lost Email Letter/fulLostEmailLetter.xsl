                                                            ...
                                                            <td>
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="notification_data/request/needed_by !=''">
                                                                        <tr>
                                                                            <td>
                                                                                <p>We want to let you know that the items you borrowed have been marked as lost and need to be returned by:
                                                                                <b><xsl:value-of select="notification_data/request/needed_by"/></b></p>
                                                                            </td>
                                                                        </tr>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <tr>
                                                                            <td>
                                                                                <p>We want to let you know that the items you borrowed have been marked as lost.</p>
                                                                            </td>
                                                                        </tr>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
