                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0">
																	<tr>
																		<td>
																			Your PIN for the library self-checkout machine is set to: <xsl:value-of select="notification_data/pin_number"/><br/><br/>
																		</td>
																	</tr>
																	<tr>
																		<td>
																			If you did not request a new PIN, please contact the Library Technology Group at 
																			<a href="tel:+16082628880">(608) 262-8880</a> or 
																			<a href="mailto:ltghelpdesk@library.wisc.edu">ltghelpdesk@library.wisc.edu</a>.
																		</td>
																	</tr>
																</table>
															</td>
