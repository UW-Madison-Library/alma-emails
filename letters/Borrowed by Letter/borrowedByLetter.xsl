                                                        ...
                                                        <tr>
                                                            <td style="margin: 0; padding: 10px 0;">
                                                                <h1 style="font-weight: normal; border-bottom: 1px solid lightgrey; padding-bottom: 10px; text-align: center; font-size: 20px!important;border-top: 1px solid lightgrey; padding-top: 13px;">
                                                                    An Item Was Picked Up by Your Authorized Person
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 20px;">
                                                                    <xsl:if test="notification_data/message">
                                                                                ...
                                                                                <xsl:for-each select="notification_data">
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="borrower/preferred_first_name !=''">
                                                                                            <xsl:value-of select="borrower/preferred_first_name"/>
                                                                                            <xsl:if test="borrower/preferred_last_name !=''">
                                                                                                &#160;
                                                                                                <xsl:value-of select="borrower/preferred_last_name"/>
                                                                                            </xsl:if>.
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                        ...
                                                                        <tr style="padding-top: 20px;">
                                                                            <td>
                                                                                Check your
                                                                                <a href="https://account.library.wisc.edu/" target="_blank">library account
                                                                                </a> for due dates.
                                                                                <br/>
                                                                            </td>
                                                                        </tr>
                                                                    ...
                                                                    <xsl:if test="notification_data/phys_item_display/title">
                                                                        <tr>
                                                                            <td style="padding: 0; padding-top: 30px;">
                                                                                <h2 style="font-size: 18px; padding: 0; margin: 0;">Loans</h2>
                                                                            </td>
                                                                        </tr>
                                                                        <tr >
                                                                            <td>
