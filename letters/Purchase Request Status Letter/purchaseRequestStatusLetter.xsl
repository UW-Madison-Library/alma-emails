                                                                ...
                                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 20px;">
                                                                    <tr>
                                                                        <td>
                                                                            <xsl:choose>
                                                                                <xsl:when test="/notification_data/purchase_request/request_status='APPROVED'">
                                                                                    We have approved your purchase request and created order <xsl:value-of select="notification_data/purchase_request/poline_reference" />.
                                                                                </xsl:when>
                                                                                <xsl:otherwise>
                                                                                    We were unable to approve your purchase request for the following reason: <xsl:value-of select="notification_data/purchase_request/reject_reason_desc" />.
                                                                                </xsl:otherwise>
                                                                            </xsl:choose>
                                                                            <br /><br />
                                                                            <b>Requested title: </b><xsl:value-of select="notification_data/purchase_request/title" />.
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
