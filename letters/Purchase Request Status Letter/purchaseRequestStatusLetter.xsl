                                                ...
                                                <td align="center" valign="top" style="padding: 20px;">
                                                    <table class="mainContent" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; max-width: 500px !important;">
                                                        ...
                                                        <table role='presentation'  cellspacing="0" cellpadding="5" border="0">
                                                            <tr>
                                                                <td>Your purchase request with the following information has been 
                                                                    <xsl:choose >
                                                                        <xsl:when test="/notification_data/purchase_request/request_status='APPROVED'">
                                                                            approved and an order has been created <xsl:value-of select="notification_data/purchase_request/poline_reference" />.
                                                                        </xsl:when>
                                                                        <xsl:otherwise>
                                                                            rejected with the following reason <xsl:value-of select="notification_data/purchase_request/reject_reason_desc" />.
                                                                        </xsl:otherwise>
                                                                    </xsl:choose>
                                                                    <br /><br /><b>Title:</b> <xsl:value-of select="notification_data/purchase_request/title" />.
                                                            </td>
                                                            </tr>
