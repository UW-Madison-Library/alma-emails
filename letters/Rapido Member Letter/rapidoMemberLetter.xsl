                                                    ...
                                                    <table class="mainContent" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; max-width: 500px !important;">
                                                        <tr>
                                                            <td style="margin: 0; padding: 10px 0;">
                                                                <h1 style="font-weight: normal; border-bottom: 1px solid lightgrey; padding-bottom: 10px; text-align: center; font-size: 20px!important;border-top: 1px solid lightgrey; padding-top: 13px;">
                                                                    Proposal for New Resource Sharing Partnership
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 0px 10px;">
																We found the following resource in your collection and would like to request it from your library:
															</td>
														</tr>
														<tr>
															<td><br/></td>
													 	...
													 	<tr>
                                                            <td style="padding: 0px 10px;">
                                                                <table class="darkmode-heading" role="presentation" width="100%" cellspacing="0" cellpadding="5" 
																	...
																	<xsl:if test="string-length(notification_data/request/display/material_type) > 0">
																		<tr>
																			<td style="vertical-align: top; padding: 10px 20px;">
																				<b>Format:</b><br/>
																				<xsl:value-of select="notification_data/request/display/material_type"/><br/>
																			</td>
																		</tr>
																	</xsl:if>
																	...
																	<xsl:if test="string-length(notification_data/request/display/autho_initials) > 0">
																		<tr>
																			<td style="vertical-align: top; padding: 10px 20px;">
																				<b>Author Initials:</b><br/>
																				<xsl:value-of select="notification_data/request/display/autho_initials"/><br/>
																			</td>
																		</tr>
																	</xsl:if>
														...
														<tr>
															 <td style="padding: 0px 10px;">
																If you agree to ship us the resource, you can copy our partner in from the Community tab in Alma. 
															</td>
														</tr>
														<tr>
															 <td style="padding: 0px 10px;">
															 	<ul>
																	<xsl:if test="notification_data/partner_jwt !=''">
																		...
																		University of Wisconsin - Madison - ILL Library
																		</a>
																		</li>
																	</xsl:if>
																	<li>ISO symbol: <b><xsl:value-of select="notification_data/iso_symbol"/></b></li>
																</ul>
															</td>
														</tr>
														<tr>
