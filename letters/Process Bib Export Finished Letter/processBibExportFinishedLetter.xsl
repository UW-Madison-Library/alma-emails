                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 20px;">
                                                                    <tr>
                                                                        <td>
                                                                            The export job has been completed: <br/>
                                                                            <b>PID:
                                                                            <xsl:value-of select="/notification_data/process"/></b><br/><br/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                           <xsl:value-of select="/notification_data/ftp"/>
                                                                        </td>
                                                                    </tr>
			                                                    </table>
                                                            </td>
