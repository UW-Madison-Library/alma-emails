...
<!-- START CUSTOM - We were seeing empty content when a patron had a fine and no items currently on loan. -->
																<xsl:if test="notification_data/organization_fee_list/string">
																	...
																	<tr>
																		<td>
																			Please visit your <a href="https://account.library.wisc.edu/?return=https://search.library.wisc.edu/" target="_blank">library account</a> for payment options for fines and fees.
																			<br/><br/>
																		</td>
																	</tr>
                                                                </xsl:if>
