...
<xsl:stylesheet version="1.0" xmlns:xsl="https://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template name="libraryLogo">
       ...
       <tr>
           <td class="darkmode" align="center" valign="top" style="background-color: #005777; background: linear-gradient(#005777,#005777);">
               <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                   <tr>
                       <td align="center" valign="top" style="padding: 20px 0;">
                           <a href="https://www.wisconsin.edu/" style="color: #005777;" target="_blank">
                               <img src="https://web.lib.wisc.edu/a/images/UW-logo-white.png" width="auto" height="134" alt="Universities of Wisconsin Libraries" style="border: 0;"/>
                           </a>
                       </td>
                   </tr>
               </table>
