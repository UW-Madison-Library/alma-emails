                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                ...
                                Email us at <a href="mailto:ltgsharedsystem@library.wisc.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">ltghelpdesk@library.wisc.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
