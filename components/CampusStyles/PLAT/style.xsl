    ...
    <xsl:template name="libraryLogo">
        <tr style="display: none;" aria-hidden="true">
            <td align="center" valign="top" style="padding: 20px 0;">
                <a href="https://www.uwplatt.edu/department/karrmann-library" style="color: #5e6263;" target="_blank">
                    <img src="cid:logo.jpg" alt="University of Wisconsin-Platteville Library Logo" width="auto" height="40"/>
                </a>
            </td>
        </tr>
        <tr>
            <td class="darkmode" align="center" valign="top" style="background-color: #5e6263;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td align="center" valign="top" style="padding: 20px 0;">
                           <a href="https://www.uwplatt.edu/department/karrmann-library" style="color: #5e6263;" target="_blank">
                               <img src="https://cdn.uwplatt.edu/logo/horizontal/official/b_clear/1024x160.png" width="600" height="auto" alt="University of Wisconsin-Platteville Karrmann Library" style="border: 0;"/>
                           </a>
                        </td>    
                    </tr>
                </table>
        ...
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    ...
                    <p style="margin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">Karrmann Library Circulation</p>
                    <p style="padding-bottom: 5px;">For assistance, email us at <a href="mailto:circulation@uwplatt.edu" target="_blank" style="color: #005777; text-decoration: underline;">circulation@uwplatt.edu</a></p>
                </td>
            </tr>
        </table>
    </xsl:template>
    ...
    <xsl:template name="ILLSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">Karrmann Library Interlibrary Loan (ILL)</p>
                    <p style="padding-bottom: 5px;">For assistance, email us at <a href="mailto:ill@uwplatt.edu" target="_blank" style="color: #005777; text-decoration: underline;">ill@uwplatt.edu</a></p>
                </td>
            </tr>
        </table>
    </xsl:template>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                Fill out our <a href="https://uwplatteville.co1.qualtrics.com/jfe/form/SV_6gwxCbLzq5oEQPr" target="_blank" style="color: #005777; text-decoration: underline;">General Assistance Form</a><br/>
                                Email us at <a href="mailto:reference@uwplatt.edu" target="_blank" style="color: #005777; text-decoration: underline;">reference@uwplatt.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table role="presentation" class="wMobile" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px!important;">
            <tr>
                <td class="footer" align="center" valign="top" style="padding:20px 0;">
                    <p style="text-align: left; padding-left: 10px; margin: 0; font-size:14px!important;">&#169; University of Wisconsin-Platteville and The Board of Regents - Universities of Wisconsin</p>
                </td>
            </tr>
        </table>
    </xsl:template>
