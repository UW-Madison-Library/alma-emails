...
<xsl:stylesheet version="1.0" xmlns:xsl="https://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template name="libraryLogo">
        <tr aria-hidden="true">
            <td>
                <a href="https://library.uwosh.edu" style="color: #005777;" target="_blank">
                    <img src="cid:logo.jpg" alt="Polk Library Logo" width="auto" height="40"/>
                </a>
            </td>
        </tr>
        ...
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    ...
                    <p style="margin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">Polk Library Circulation</p>
                    <p style="padding-bottom: 5px;">For assistance, please:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                        <tr>
                            <td style="padding-bottom: 10px; font-size: 16px;">
                                
                                Email us at <a href="mailto:circulation@uwosh.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">circulation@uwosh.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="ILLSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">Polk Library Circulation</p>
                    <p style="padding-bottom: 5px;">For assistance, please:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
    ...
    <xsl:template name="AcquisitionsSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">Polk Library Acquisitions Department</p>
                    <p style="padding-bottom: 5px;">For assistance, please:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                Email us at <a href="mailto:libraryorders@uwosh.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">libraryorders@uwosh.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                Email us at <a href="mailto:librarytechnology@uwosh.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">librarytechnology@uwosh.edu</a><br/>
                                Email us at <a href="mailto:circulation@uwosh.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">circulation@uwosh.edu</a>
                            </td>
                        </tr>
                    </table>
        ...
        <table role="presentation" class="wMobile" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px!important;">
            <tr>
                <td class="footer" align="center" valign="top" style="padding:20px 0;">
                    <p style="text-align: left; padding-left: 10px; margin: 0; font-size:14px!important;">&#169; University of Wisconsin Oshkosh</p>
                </td>
            </tr>
        </table>
    </xsl:template>
