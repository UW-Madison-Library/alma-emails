...
<xsl:stylesheet version="1.0" xmlns:xsl="https://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="libraryLogo">
        <tr aria-hidden="true">
            <td>
                <a href="https://students.uwrf.edu/Library" style="color: #0073CE;" target="_blank">
                    <img src="cid:logo.jpg" alt="University of Wisconsin-River Falls Logo" width="auto" height="20"/>
                </a>
            </td>
        </tr>       
    </xsl:template>
        ...
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    ...
                    <p style="margin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-River Falls Chalmer Davee Library Access Services</p>
                    <p style="padding-bottom: 5px;">For assistance, please</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                        <tr>
                            <td style="padding-bottom: 10px; font-size: 16px;">
                                Email us at <a href="mailto:circulation@uwrf.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">circulation@uwrf.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="ILLSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-River Falls Chalmer Davee Library Resource Sharing</p>
                    <p style="padding-bottom: 5px;">For assistance, please:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                Email us at <a href="mailto:circulation@uwrf.edu?subject=Resource Sharing" target="_blank" style="color: #0073CE; text-decoration: underline;">circulation@uwrf.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="AcquisitionsSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-River Falls Chalmer Davee Library Collection Services</p>
                    <p style="padding-bottom: 5px;">For assistance, please:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                Email us at <a href="mailto:acquisitions@uwrf.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">acquistions@uwrf.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                ...
                                Email us at <a href="mailto:erm-cdl@uwrf.edu?subject=Alma System Administrator" target="_blank" style="color: #0073CE; text-decoration: underline;">erm-cdl@uwrf.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
