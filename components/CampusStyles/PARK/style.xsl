...
<!-- Parkside link color updated to branded green - #016836 light mode, #01A254 dark mode. All other styles remain shared UW template -->
   ...
   <xsl:template name="libraryLogo">
        <tr aria-hidden="true">
            <td>
                <a href="https://www.uwp.edu/learn/library" style="color: #016836;" target="_blank">
                    <img src="cid:logo.jpg" alt="UW-Parkside Library" width="auto" height="20"/>
                </a>
            </td>
        </tr>
        <tr>
    ...
    <table cellspacing="0" cellpadding="0" border="0" role="presentation">
        <tr>
            <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                ...
                <p style="margin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW–Parkside Library</p>
                <p style="padding-bottom: 5px;">If you have questions, please:</p>
                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                    <tr>
                        <td style="padding-bottom: 10px; font-size: 16px;">
                            Email <a href="mailto:circulationlib@uwp.edu" target="_blank" style="color: #016836; text-decoration: underline;">circulationlib@uwp.edu</a> about this notice<br/>
                            Or email <a href="mailto:AskUs@uwp.edu" target="_blank" style="color: #016836; text-decoration: underline;">AskUs@uwp.edu</a> for general help
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                    <tr>
                        <td style="padding-bottom: 10px;">
                            Email <a href="mailto:rislib@uwp.edu" target="_blank" style="color: #016836; text-decoration: underline;">rislib@uwp.edu</a> about this notice<br/>
                            Or email <a href="mailto:AskUs@uwp.edu" target="_blank" style="color: #016836; text-decoration: underline;">AskUs@uwp.edu</a> for general help
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                    <tr>
                        <td style="padding-bottom: 10px;">
                            Email <a href="mailto:AskUs@uwp.edu" target="_blank" style="color: #016836; text-decoration: underline;">AskUs@uwp.edu</a> for general help
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                    <tr>
                        <td style="padding-bottom: 10px;">
                            Contact us <a href="https://libguides.uwp.edu/directory" target="_blank" style="color: #016836; text-decoration: underline;">(staff directory)</a><br/>
                            Or email <a href="mailto:AskUs@uwp.edu" target="_blank" style="color: #016836; text-decoration: underline;">AskUs@uwp.edu</a> for general help
                        </td>
                    </tr>
                </table>
    ...
    <table role="presentation" class="wMobile" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px!important;">
        <tr>
            <td class="footer" align="center" valign="top" style="padding:20px 0;">
                <p style="text-align:left; padding-left:10px; margin:0; font-size:14px!important;">UW–Parkside Library</p>
                <p style="text-align:left; padding-left:10px; margin:0; font-size:14px!important;">Questions? Email <a href="mailto:AskUs@uwp.edu" style="color:#016836;">AskUs@uwp.edu</a></p>
