...
<xsl:stylesheet version="1.0" xmlns:xsl="https://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="libraryLogo">
        <tr aria-hidden="true">
            <td>
                <a href="https://library.uwsp.edu/home" style="color: #005777;" target="_blank">
                    <img src="cid:logo.jpg" alt="University of Wisconsin Stevens Point Libraries Logo" width="auto" height="50"/>
                </a>
            </td>
        </tr>
    </xsl:template>
                    ...
                    <xsl:for-each select="notification_data">
                        <xsl:choose>
                            <xsl:when test="receivers/receiver/user/preferred_first_name !=''">
                                Hello <xsl:value-of select="receivers/receiver/user/preferred_first_name"/>&#160;<xsl:value-of select="receivers/receiver/user/preferred_last_name"/>,
                            </xsl:when>
                            <xsl:otherwise>
                                Hello <xsl:value-of select="receivers/receiver/user/first_name"/>&#160;<xsl:value-of select="receivers/receiver/user/last_name"/>,
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:for-each>
                </td>
    ...
    <xsl:template name="libraryAdminSalutation">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 20px;">
                    Hello Library System Administrator,
                </td>
            </tr>
        </table>
    </xsl:template>
        ...
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    ...
                    <p style="margin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-Stevens Point Libraries Circulation Support</p>
                    <p style="padding-bottom: 5px;">For assistance, please</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                        <tr>
                            <td style="padding-bottom: 10px; font-size: 16px;">
                                Email us at <a href="mailto:Library.Circulation@uwsp.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">Library.Circulation@uwsp.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="ILLSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UWSP Libraries Interlibrary Loan (ILL)</p>
                    <p style="padding-bottom: 5px;">For assistance, please</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                ...
                                Email us at <a href="mailto:Interlibrary.Loan@uwsp.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">InterLibrary.Loan@uwsp.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="AcquisitionsSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UWSP Libraries Acquisitions Department</p>
                    <p style="padding-bottom: 5px;">For assistance, please:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
    ...
    <xsl:template name="AdminSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">Alma System Administration</p>
                    <p style="padding-bottom: 5px;">For assistance, please:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                ...
                                Email us at <a href="mailto:library.alma.system@uwsp.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">library.alma.system@uwsp.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <head>
			...
			<style>
                ...
                .barcode { 
                    ...
                    font-size: 20px; <!--changed font size from 38 down to 20 08012026 DHM-->
                    padding-left: 20px; <!--changed padding from 32 down to 20-->
                }
                .messageBody {
                    width: 50% ;
                }
