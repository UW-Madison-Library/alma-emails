...
<xsl:stylesheet version="1.0" xmlns:xsl="https://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="libraryLogo">
        <tr aria-hidden="true">
            <td>
                <a href="https://library.uwgb.edu/" target="_blank">
                    <img src="cid:logo.jpg" alt="University of Wisconsin-Green Bay Libraries Logo" width="auto" height="50"/>
                </a>
            </td>
        </tr>
    </xsl:template>
                ...
                <td style="padding-bottom: 20px;">
                    <xsl:for-each select="notification_data">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                Dear <xsl:value-of select="user_for_printing/first_name"/>&#160;<xsl:value-of select="user_for_printing/last_name"/>,
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:for-each>
                </td>
        ...
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    ...
                    <p style="margin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-Green Bay Library</p>
                    <p style="padding-bottom: 5px;">For assistance, please visit:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                        <tr>
                            <td style="padding-bottom: 10px; font-size: 16px;">
                                <a href="https://library.uwgb.edu/ResearchHelp/" target="_blank" style=" text-decoration: underline;">Research Help</a><br/>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="ILLSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="margin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-Green Bay Library Resource Sharing</p>
                    <p style="padding-bottom: 5px;">For assistance, please email us at</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                               <a href="mailto:interloan@uwgb.edu" target="_blank" style="text-decoration: underline;">interloan@uwgb.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="AcquisitionsSignature">
            <table cellspacing="0" cellpadding="0" border="0" role="presentation">
                <tr>
                    <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                        <p style="padding: 0px 0;">Sincerely,</p>
                        <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-Green Bay Library Collection Management Department</p>
                        <p style="padding-bottom: 5px;">For assistance, please visit:</p>
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                           <tr>
                                <td style="padding-bottom: 10px;">
        ...
        <table role="presentation" class="wMobile" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px!important;">
            <tr>
                <td class="footer" align="center" valign="top" style="padding:20px 0;">
                    <p style="text-align: left; padding-left: 10px; margin: 0; font-size:14px!important;">&#169; University of Wisconsin - Green Bay Library</p>
                </td>
            </tr>
        </table>
    </xsl:template>
