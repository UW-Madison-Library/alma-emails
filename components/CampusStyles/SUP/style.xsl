...
<xsl:stylesheet version="1.0" xmlns:xsl="https://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="libraryLogo">
        <tr aria-hidden="true">
            <td>
                <a href="https://www.library.uwsuper.edu/" style="color: #0073CE;" target="_blank">
                    <img src="cid:logo.jpg" alt="University of Wisconsin-Superior Jim Dan Hill Library Logo" width="auto" height="20"/>
                </a>
            </td>
        </tr>
        ...
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    ...
                    <p style="margin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-Superior Jim Dan Hill Library Circulation Support</p>
                    <p style="padding-bottom: 5px;">For assistance, please:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                        <tr>
                            <td style="padding-bottom: 10px; font-size: 16px;">
                                Email us at <a href="mailto:circdesk@uwsuper.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">circdesk@uwsuper.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="ILLSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-Superior Jim Dan Hill Interlibrary Loan (ILL)</p>
                    <p style="padding-bottom: 5px;">For assistance, please:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                Email us at <a href="mailto:ill@uwsuper.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">ill@uwsuper.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="AcquisitionsSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-Superior Jim Dan Hill Library Acquisitions</p>
                    <p style="padding-bottom: 5px;">For assistance, please:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                Email us at <a href="mailto:hpaquett@uwsuper.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">hpaquett@uwsuper.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                Email us at <a href="mailto:askref@uwsuper.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">askref@uwsuper.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
