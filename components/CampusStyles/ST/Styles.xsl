...
<xsl:stylesheet version="1.0" xmlns:xsl="https://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="libraryLogo">
        <tr aria-hidden="true">
            <td>
                <a href="https://library.uwstout.edu" style="color: #005777;" target="_blank">
                    <img src="cid:logo.jpg" alt="University of Wisconsin Stout Logo" width="auto" height="70"/>
                </a>
            </td>
        </tr>
        <tr>
        ...
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    ...
                    <p style="margin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW Stout Library Circulation</p>
                    <p style="padding-bottom: 5px;">For assistance:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                        <tr>
                            <td style="padding-bottom: 10px; font-size: 16px;">
                                Email us at <a href="mailto:circulation@uwstout.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">circulation@uwstout.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="ILLSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-Stout Library Interlibrary Loan (ILL)</p>
                    <p style="padding-bottom: 5px;">For assistance:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                              Email us at <a href="mailto:docdel@uwstout.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">docdel@uwstout.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <xsl:template name="AcquisitionsSignature">
        <table cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    <p style="padding: 0px 0;">Sincerely,</p>
                    <p style="fmargin: 5px 0px 10px 0; padding-bottom: 10px; border-bottom: 2px solid #e5e5e5;">UW-Stout Library Acquisitions Department</p>
                    <p style="padding-bottom: 5px;">For assistance:</p>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                Email us at <a href="mailto:libacq@uwstout.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">libacq@uwstout.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td style="padding-bottom: 40px; width: 500px; padding-top: 30px;">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                       <tr>
                            <td style="padding-bottom: 10px;">
                                Email us at <a href="mailto:library@uwstout.edu" target="_blank" style="color: #0073CE; text-decoration: underline;">library@uwstout.edu</a>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table role="presentation" class="wMobile" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px!important;">
            <tr>
                <td class="footer" align="center" valign="top" style="padding:20px 0;">
                    <p style="text-align: left; padding-left: 10px; margin: 0; font-size:14px!important;">&#169; University of Wisconsin - Stout Library</p>
                </td>
            </tr>
        </table>
    </xsl:template>
